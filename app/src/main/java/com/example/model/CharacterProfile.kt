    ...
    companion object {
        val ALL_CHARACTERS = listOf(
            CharacterProfile(
                ...
                description = "Campus trendsetter who balances style with sharp instincts. Slides through deadlines like a breeze.",
                outfitDescription = "Crisp open-collar white shirt, rolled-up sleeves, black slim trousers, and cool shades.",
                ...
                imageRes = R.drawable.img_char_swagger,
            ...
            CharacterProfile(
                ...
                name = "Rahul",
                title = "School Rusher",
                tagline = "Always on the run, never misses a lecture!",
                description = "High-energy engineering enthusiast who sprints between morning 8 AM classes and lab experiments.",
                outfitDescription = "Red-and-blue plaid check shirt, beige chinos, athletic sneakers, and signature baseball cap.",
                specialPowerName = "School Dash",
                ...
                unlockCost = 0,
                unlockGraduationsRequired = 0,
                imageRes = R.drawable.img_char_rusher,
            ...
            CharacterProfile(
                ...
                name = "Vikram",
                title = "Campus Champ",
                tagline = "Run. Collect. Graduate.",
                description = "Hackathon winner and tech genius. Master of algorithms, circuit design, and securing dream tech packages.",
                ...
                imageRes = R.drawable.img_char_champ,
